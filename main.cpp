...
void paramValoare(ListaDubluInlantuita a) {
...
void demo() {
  Nod *h = new Nod(1);
  Nod *t = new Nod(2);
  ListaDubluInlantuita l(h, t);
  std::cout << l;

  /* ListaDubluInlantuita l2; */
  /* std::cin >> l2; */
  /* std::cout << "Lista initiala inainte de copiere:\n" << l2; */
  /* l2 = ListaDubluInlantuita(l); */
  /* std::cout << "Lista dupa copiere:\n" << l2; */
...
int main() {
  ...
  /* /1* folosim o mapa de la string la un enum class intrucat nu putem folosi
   * la */
  /*  * switch case uri bazate pe stringuri, si dorim ca userul sa introduca */
  /*  * comenzi de tip string *1/ */
  ...
  /*     {"v_operator_mai_mare_egal",
   * Comenzi::COMANDA_VERIFICA_OP_MAI_MARE_EGAL}, */
  ...
  /* /1* in programul interactiv este greu sa construim variabile dinamic, drept
   */
  /*  * workaround vom folosi un array de liste, si vom ruga userul sa spuna de
   * la */
  /*  * inceput cate liste va dori sa foloseasca, listele vor fi indexate pentru
   */
  /*  * user de la 1 pentru usurinta sa *1/ */
  /* int nr_ldi; /1* nr de liste *1/ */
  /* std::cout */
  ...
  /* /1* implementare meniu interactiv *1/ */
  /* /1* cat timp nu s a primit comanda de stop *1/ */
  /* while (mapComenzi[comanda] != Comenzi::COMANDA_STOP_PROGRAM) { */
  /*   /1* var folosite pentru a ne asigura ca utilizatorul introduce date
   * valide *1/ */
  /*   bool inputComandaFormatCorect{false}; */

  /*   /1* cerem o comanda utilizatorului dintr-o lista fixata + error checking
   * *1/ */
  ...
  /*     std::cin >> comanda; */
  /*     inputComandaFormatCorect = (mapComenzi.find(comanda) !=
   * mapComenzi.end()); */
  /*   } */

  /*   int index_ldi{-1}; */
  /*   /1* ce liste vom folosi pentru adunarea listelor *1/ */
  /*   int index_ldi_1{-1}; */
  /*   int index_ldi_2{-1}; */
  /*   int index_ldi_rez{-1}; */
  /*   int index_nod{-1}; */
  ...
  /*     /1* citim indexul listei din array pe care vom lucra *1/ */
  ...
  /*     if (ldi_created[index_ldi - 1]) { /1* daca lista exista *1/ */
  /*       int el, poz; */
  ...
  /*       std::cout */
  /*           << "Nu ati creat lista cu indexul " << index_ldi */
  /*           << ". Nu avem cum sa stergem noduri dintr-o lista
   * inexistenta.\n"; */
  ...
  /*     std::cout << "Nodul cerut are valoarea: " << ldi[index_ldi -
   * 1][index_nod] */
  /*               << '\n'; */
  ...
  /*                 << index_ldi_2 << ".\n"; */
  /*     } else { */
  /*       std::cout << "Lista " << index_ldi_1 << " nu este mai mica decat
   * lista " */
  /*                 << index_ldi_2 << ".\n"; */
  /*     } */
  ...
  /*     } else { */
  /*       std::cout << "Lista " << index_ldi_1 */
  /*                 << " nu este mai mica sau egala decat lista " <<
   * index_ldi_2 */
  /*                 << ".\n"; */
  /*     } */
  ...
  /*                 << index_ldi_2 << ".\n"; */
  /*     } else { */
  /*       std::cout << "Lista " << index_ldi_1 << " nu este mai mare decat
   * lista " */
  /*                 << index_ldi_2 << ".\n"; */
  /*     } */
  ...
  /* while (index_ldi_1 < 1 || index_ldi_1 > nr_ldi) { */
  /*   std::cout << "Introduceti nr listei pe care doriti sa o concatenati ([1,"
   */
  /*             << nr_ldi << "]) "; */
  /*   std::cin >> index_ldi_1; */
  /* } */
  /* while (n < 0) { */
  /*   std::cout << "Introduceti de cate ori doriti sa concatenati lista
   * \n(ATENTIE " */
  ...
  /* } */
  /* while (index_ldi_2 < 1 || index_ldi_2 > nr_ldi) { */
  /*   std::cout << "Introduceti nr listei unde doriti sa salvati rezultatul
   * ([1," */
  /*             << nr_ldi << "]) "; */
  /*   std::cin >> index_ldi_2; */
  /* } */
  ...
  /* default: */
  /* /1* putem ajunge aici decat daca a fost introdusa comanda STOP, care va */
  /*  * opri loop ul *1/ */
  /* break; */
  /* } */
  /* } */
